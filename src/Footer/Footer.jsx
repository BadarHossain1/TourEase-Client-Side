    ...
    return (
        <div>
            <footer className="footer footer-center p-10 text-base-content rounded bg-black">
                <Link to="/" className=" text-4xl font-extrabold font-playfair-display flex items-center justify-center mr-2 text-white"><MdTravelExplore className="w-10 h-10 mr-1" />Tour<span className="text-[#0057d9]">Ease</span></Link>
